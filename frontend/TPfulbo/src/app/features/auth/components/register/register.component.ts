...
import { RegisterRequest } from '../../../../models/requests/auth.request'; // Corrected import path
...
export class RegisterComponent {
  ...
  onSubmit() {
    ...
    if (!this.age) { this.ageError = 'La edad es requerida.'; isValid = false; }
    ...
    if (this.age) {
      if (this.age < 0) {
        this.ageError = 'Ingrese un valor válido.'; isValid = false;
      }
    }
